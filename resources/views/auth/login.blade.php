...
<!-- Mirrored from corporx.themetags.com/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Aug 2020 08:37:45 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="bg-cover vh-100 ml-n3 gradient-overlay" style="background-image: url(img/slider-img-5.jpg);">
                        <div class="position-absolute login-signup-content">
                            <div class="position-relative text-white col-md-12 col-lg-7">
                                ...
                                <a href="/" class="btn  secondary-solid-btn border-radius mt-4 mb-3">
                                    Public Site
                                </a>
                            </div>
                        </div>
