...
<head>
    ...
    <link href="/admin/plugins/global/plugins.bundlec3e8.css?v=7.0.6" rel="stylesheet" type="text/css" />
    <link href="/admin/plugins/custom/prismjs/prismjs.bundlec3e8.css?v=7.0.6" rel="stylesheet" type="text/css" />
    <link href="/admin/css/style.bundlec3e8.css?v=7.0.6" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="header-fixed subheader-enabled page-loading">
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <div id="kt_header_mobile" class="header-mobile">
                    <!--begin::Logo-->
                    <a href="/admins">
                        <img alt="Logo" src="/admin/media/logos/fmc_logo.png" class="max-h-30px" />
                    </a>
                    <!--end::Logo-->
                ...
                <div id="kt_header" class="header header-fixed">
                    ...
                    <div class="container">
                        ...
                        <div class="d-none d-lg-flex align-items-center mr-3">
                            <!--begin::Logo-->
                            <a href="/admins" class="mr-20">
                                <img alt="Logo" src="/admin/media/logos/fmc_logo.png" class="logo-default max-h-35px" />
                            </a>
                            <!--end::Logo-->
                        </div>
                        <!--begin::Topbar-->
                            ...
                            <ul class="menu-nav">
                                    ...
                                    <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                        <ul class="menu-subnav">
                                            <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                <a href="/admin/enquery_services" class="menu-link">
                                ...
                                <li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="click" aria-haspopup="true">
                                    ...
                                    <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                                        <ul class="menu-subnav">
                                            <li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
                                                <a href="/admin/enquery_products" class="menu-link">
                                                    <span class="svg-icon menu-icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                                <polygon points="0 0 24 0 24 24 0 24" />
                ...
                <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                    <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="http://keenthemes.com/metronic" target="_blank" class="text-white text-hover-primary">FMC Boat | Deleloped By DataCube Software</a>
                        </div>
                    </div>
                </div>
                <!--end::Footer-->
    ...
    <script src="/admin/plugins/global/plugins.bundlec3e8.js?v=7.0.6"></script>
    <script src="/admin/plugins/custom/prismjs/prismjs.bundlec3e8.js?v=7.0.6"></script>
    <script src="/admin/js/scripts.bundlec3e8.js?v=7.0.6"></script>
